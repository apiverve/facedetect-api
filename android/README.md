...
```gradle
dependencies {
    implementation 'com.github.apiverve:facedetect-api:1.1.13'
}
```
...
```java
import com.apiverve.facedetect.FaceDetectorAPIClient;
import com.apiverve.facedetect.APIResponse;
import com.apiverve.facedetect.APIException;

// Initialize the client
FaceDetectorAPIClient client = new FaceDetectorAPIClient("YOUR_API_KEY");
...
This API requires a file upload. Supported file types: .jpg, .jpeg, .png, .gif, .webp (max 10MB)
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/facedetect](https://docs.apiverve.com/ref/facedetect)
...
- **Documentation:** [https://docs.apiverve.com/ref/facedetect](https://docs.apiverve.com/ref/facedetect)
- **Issues:** [GitHub Issues](https://github.com/apiverve/facedetect-api/issues)
