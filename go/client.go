...
const (
	baseURL        = "https://api.apiverve.com/v1/facedetect"
	defaultTimeout = 30 * time.Second
)

// Client is the Face Detector API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Face Detector API client.
...
// ExecuteWithFile makes a request to the Face Detector API with a file upload.
...
// Execute makes a request to the Face Detector API with typed parameters.
//
