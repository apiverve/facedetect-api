...
namespace APIVerve.API.FaceDetector
{
    ...
    /// <summary>
    /// Client for the FaceDetector API
    /// </summary>
    public class FaceDetectorAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/facedetect";
        ...
        private static readonly Dictionary<string, ValidationRule> _validationRules = new Dictionary<string, ValidationRule>
        {
            ...
            { "confidence", new ValidationRule { Type = "number", Required = false, Min = 0.1, Max = 1 } }
        };
        ...
        public FaceDetectorAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public FaceDetectorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public FaceDetectorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, FaceDetectorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(FaceDetectorQueryOptions options)
        {
        ...
        public ResponseObj Execute(FaceDetectorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(FaceDetectorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(FaceDetectorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(FaceDetectorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(FaceDetectorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(FaceDetectorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(FaceDetectorQueryOptions options)
        {
