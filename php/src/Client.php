 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/facedetect?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/facedetect';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\FacedetectClient] {$message}\n";
        }
    }
}
